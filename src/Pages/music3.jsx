...
import audio from "./Jagatare-Paibuni-Emiti-Thakura-Tie-(OdiaFresh.Com).mp3";
  ...
  return (
    <div className={styles.container}>
      <div className={styles.display}>
        <div>
          <img
            src="https://tse2.mm.bing.net/th?id=OIP.HWxstVbwKaHiPmweqcvaCAHaEK&pid=Api&P=0&h=180"
            alt="pic"
