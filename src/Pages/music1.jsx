...
import audio from "./Batabana-Hela-Mo-Prema-(Asima-Panda)-New-Romantic-Odia-Song.mp3";
  ...
  return (
    <div className={styles.container}>
      <div className={styles.display}>
        <div>
          <img
            src="https://tse1.mm.bing.net/th?id=OIP.Vn5AcmvWiqdMzFZdJVdmxwFZC1&pid=Api&P=0&h=180"
            alt="pic"
